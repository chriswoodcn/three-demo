...
#define CUSTOM_GLSL_FILTER_COLOR
#ifdef CUSTOM_GLSL_INVERT_COLOR
color.r = 1.0 - color.r;
color.g = 1.0 - color.g;
color.b = 1.0 - color.b;
#endif
...
#define CUSTOM_GLSL_FILTER_COLOR
#ifdef CUSTOM_GLSL_FILTER_COLOR
color.r = color.r * 27.0/255.0;
color.g = color.g * 173.0/255.0;
color.b = color.b * 170.0/255.0;
#endif
